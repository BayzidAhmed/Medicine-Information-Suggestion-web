       ...
       <table class="table table-bordered">
        ...
        <?php foreach ($data as $row) { ?>
          ...
          <tr>
            ...
            <td>
              <a style="margin-bottom: 5px" href="edit.php?id=<?php echo $row['med_id'] ?>" type="button" class="btn btn-primary">Edit</a>
              <a href="delete.php?id=<?php echo $row['med_id'] ?>" type="button" class="btn btn-danger">Delete</a>
            </td>
